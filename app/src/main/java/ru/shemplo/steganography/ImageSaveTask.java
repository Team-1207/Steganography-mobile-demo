...
public class ImageSaveTask extends AsyncTask <T3 <Context, Bitmap, String>, Void, Void> {
    ...
    @Override
    @SafeVarargs
    protected final Void doInBackground(T3<Context, Bitmap, String>... bitmaps) {
        ...
        Log.i ("ISaT", "Picture path: " + imageURI.toString ());
        try (OutputStream os = contentResolver.openOutputStream (imageURI)) {
            ...
            Log.e ("ISaT", "Failed to save modified image", ioe);
        }
